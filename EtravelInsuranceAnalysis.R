...
mortality_df <- read_excel("./2_Data/mortality_data_merged.xlsx") %>% 
...
df_tables %>% 
  ...
  flextable() %>%
  theme_vanilla() %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table2.docx")
...
df_tables %>% 
  ...
  autofit() %>% 
  theme_vanilla() %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table3.docx")
...
df_tables %>% 
  ...
  theme_vanilla() %>%
  autofit() %>% 
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table4.docx")
...
df_tables %>% 
  ...
  theme_vanilla() %>%
  autofit() %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table5.docx")
...
df %>%
  ...
  bold(j = 1, bold = TRUE) %>%
  theme_vanilla() %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table6.docx")
...
df %>%
  ...
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table8.docx")
...
df %>%
  ...
  set_header_labels(`Mortality by Covid19 in the area of residence` = "Mortality by Covid19 in the area of residence",
                    ...
                    mean_wtp_expensive = "Expensive",
                    t_test_cheap = "T-test (p-value)") %>%
save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table9.docx")
...
flextable() %>%
  ...
  set_header_labels(treatment = "Treatment", cheap = "Cheap", expensive = "Expensive",
                    chi_res = "Chi Squared") %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table11.docx")
####========================================================================####
# 3.81 CHECK IF TABLE 11 WAS PROPERLY CALCULATED
####=========================================================================###
chisq.test(rationality_df$cheap) #compares negative vs positive por cheap cell (4,2)
chisq.test(rationality_df$expensive) #compares negative vs positive por expensive cell(4,3)

#chisq.test(c(2,2)) #takes the values of the table and compares cheap vs expensive when negative cell (2,4)
#chisq.test(c(4,5)) #takes the values of the table and compares cheap vs expensive when negative cell (3,4)
#chisq.test(c(445, 621)) #comparing expensive vs cheap packages 
####========================================================================####
# Result: It was!
####=========================================================================###
...
df %>%
  ...
  theme_vanilla()%>%
  autofit() %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table13.docx")
...
df %>%
  ...
  merge_v(j = "bias") %>% 
  theme_vanilla()%>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table14.docx")
...
df %>%
  ...
  merge_v(j = "bias") %>% 
  theme_vanilla()   %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table15.docx")
...
df %>%
  ...
  merge_v(j = "bias") %>% 
  theme_vanilla()   %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/table16.docx")
...
stargazer(reg1, reg2, reg3,
          ...
          type = "html",
          out = "./1_Analysis/EtravelInsurance/RegOutput/Table7_likelihoodcovid.doc")
...
stargazer(reg1,reg2,reg3,reg4,
          ...
          type = "html",
          out = "./1_Analysis/EtravelInsurance/RegOutput/Table10regp75.doc")
...
df %>%
  ...
  flextable() %>% 
  theme_vanilla() %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/page4.docx")
...
plot_df %>%
  ...
  theme_vanilla() %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/graph_description.docx")

####==========================================================================####
# 7 Sentiment Analysis
####==========================================================================####

sent_df <- read_excel("./1_Analysis/SentAnalysis/sentiment_data(v2).xlsx")
...
sent_df %>%
  ...
  flextable() %>%
  theme_vanilla() %>% 
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/page9_sent_rho.docx")
...
sent_df %>%
  ...
  merge_v(j = "chi_test") %>%
  theme_vanilla() %>%
  save_as_docx(., path = "./1_Analysis/EtravelInsurance/FlexTables/page9_sent_chi.docx")
